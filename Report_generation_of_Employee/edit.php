		...
		<div class="content">
			...
			if(isset($_POST['save'])){
				...
				if($update){
					...
					echo '<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Failled to save, silahkan coba lagi.</div>';
				}
			}
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<select name="jabatan" class="form-control" required>
							<option value=""> - Employee Post. - </option>
                    ...
                    <div class="col-sm-3">
                    <b>Current Emp.Post.:</b> <span class="label label-success"><?php echo $row['jabatan']; ?></span>
				    </div>
				</div>
				<div class="form-group">
